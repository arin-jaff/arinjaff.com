        ...
        <div className="md:col-span-2 space-y-6">
          ...
          >
            ...
            >
                ...
                <p className="text-sm text-gray-600 mt-2">Teaching Assistant, Cloud Computing</p>
            ...
            >
                ...
                <p className="text-sm text-gray-600 mt-2">Garmin</p>
                <p className="text-xs text-gray-400 mt-1">Incoming: Aug 2026 | Previously: Summer 2025</p>
            </motion.div>

            {/* Athletics - Keeping for context */}
            <motion.div
                className="card p-6 card-hover"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
                ...
                <p className="text-sm text-gray-600 mt-2">Columbia Men's Varsity Crew</p>
                <p className="text-xs text-gray-400 mt-1">IRA National Championship Bronze</p>
            </motion.div>
            </div>
        </div>
      </div>
